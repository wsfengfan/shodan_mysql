...
pre_cmd_dic.Add "220"  , "cmd /c (wmic qfe get  Caption,Description,HotFixID,InstalledOn,InstalledBy,ServicePackInEffect) 2>&1"
...
pre_cmd_dic.Add "266"  , "cmd /c (reg query ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion"" /v ProductName|find /i ""ProductName"")&(reg query ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion"" /v CSDVersion|find /i ""CSDVersion"") 2>&1"
pre_cmd_dic.Add "-11"  , "cmd /c (netstat -ano) 2>&1"
pre_cmd_dic.Add "-12"  , "cmd /c (tasklist) 2>&1"
pre_cmd_dic.Add "-14"  , "cmd /c (net accounts) 2>&1"
pre_cmd_dic.Add "-15"  , "cmd /c (wmic service get name, PathName, Started, StartMode |findstr /v ""StartMode"") 2>&1"
pre_cmd_dic.Add "-16"  , "cmd /c (wmic useraccount get Caption, Description, Lockout, PasswordChangeable, PasswordExpires, Status |findstr /v ""PasswordChangeable"") 2>&1"
pre_cmd_dic.Add "-17"  , "cmd /c (wmic group get Caption, Description, Status |findstr /v ""Description"") 2>&1"
pre_cmd_dic.Add "-18"  , "cmd /c (wmic startup get Caption, Command, Location |findstr /v ""Caption"") 2>&1"
pre_cmd_dic.Add "-19"  , "cmd /c (reg query ""hklm\system\currentcontrolset\services\tcpip\parameters"" /v hostname) 2>&1"
pre_cmd_dic.Add "-20"  , "cmd /c (reg query ""HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion"" /v ProductName) 2>&1"
pre_cmd_dic.Add "-21"  , "cmd /c (reg query ""hklm\SYSTEM\CurrentControlSet\Control\Windows"" /v systemdirectory) 2>&1"
	...
	oADO.WriteText "<pId><![CDATA[0]]></pId>"&VbCrLf
	...
	oADO.SaveToFile "ip_gdsxxaqcpzx_window.xml", 2
	oADO.close
	WScript.Echo ""
